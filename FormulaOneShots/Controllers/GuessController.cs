...
namespace FormulaOneShots.Controllers
{
    public class GuessController : Controller
    {
        ...
        public GuessController(GuessesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,User,Year,Race,PolePosition,RandomGuess,LastChange")] Shots shots)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,User,Year,Race,PolePosition,RandomGuess,LastChange")] Shots shots)
        {
            if (id != shots.Id)
            {
                return NotFound();
